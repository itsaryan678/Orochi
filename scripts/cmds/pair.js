...
module.exports = {
 config: {
  ...
  longDescription: {
   en: "Know your destiny and find out who you might complete your life with",
  },
  category: "fun",
  guide: {
 ...
 onStart: async function ({ api, args, message, event, threadsData, usersData, dashBoardData, globalData, threadModel, userModel, dashBoardModel, globalModel, role, commandName, getLang }) {
  ...
  let quote = "";
  try {
   const quoteResponse = await axios.get("https://randomapiz.vercel.app/love");
   quote = quoteResponse.data.love || "Love is unpredictable!";
  } catch (error) {
   quote = "Love is unpredictable!";
  }
  ...
  return api.sendMessage({
   body: `🎉 Congratulations ${name1}! Looks like destiny brought you together with ${name2}.\nYour link percentage is ${tile}% 😎✨\n\n${quote}`,
   mentions: [
    { tag: `${name2}`, id: id2 },
    { tag: `${name1}`, id: id1 }
   ],
