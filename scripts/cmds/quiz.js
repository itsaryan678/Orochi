...
module.exports = {
  ...
  onStart: async function ({ message, event, usersData, commandName, getLang, args, api }) {
    ...
    try {
      let response;
      if (category === 'torf') {
        response = await axios.get(`https://c-v5.onrender.com/api/quiz?category=torf`);
        ...
        response = await axios.get(`https://c-v5.onrender.com/api/quiz?category=anime`);
...
const hint = Qdata.traits;
       ...
       message.reply({
        ...
        response = await axios.get(`https://c-v5.onrender.com/api/quiz?category=flag`);
        const Qdata = response.data;
        ...
        response = await axios.get(`https://c-v5.onrender.com/api/quiz?category=${category}`);
        const Qdata = response.data;
